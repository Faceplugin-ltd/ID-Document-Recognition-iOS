...
final class AboutViewController: UIViewController {
    override func viewDidLoad() {
        ...
        let productBody = card(
            "This app demos the Document Reader SDK for iOS: ID cards, passports, and driver licenses with OCR, MRZ, barcode, and optional liveness checks. Everything runs fully on-premise."
        )
